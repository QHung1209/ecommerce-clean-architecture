...
describe('Permission Entity', () => {
  it('should create a Permission entity successfully', () => {
    const props = { name: 'Create Product', description: 'Allows creating product', path: '/products', method: HTTPMethod.POST };
  ...
  it('should update a Permission entity', () => {
    const permission = Permission.create({ name: 'Old', description: '', path: '/', method: HTTPMethod.GET });
